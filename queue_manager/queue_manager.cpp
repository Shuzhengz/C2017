...
void QueueManager::StartLogging() {
  ...
  logger_.AddQueue("ground_ball_intake_status",
  ...
  webdash_.AddQueue("ground_ball_intake_status",
                    &ground_ball_intake_status_queue_);
  ...
  const std::vector<std::string> auto_list_ = {"NONE",
                                               "BLUE_HELLA_KPA",
                                               "BLUE_HELLA_KPA_NEW",
...
// Shooter
c2017::shooter::ShooterInputQueue* QueueManager::shooter_input_queue() {
  return &shooter_input_queue_;
}

c2017::shooter::ShooterStatusQueue* QueueManager::shooter_status_queue() {
...
// Climber
c2017::climber::ClimberInputQueue* QueueManager::climber_input_queue() {
  return &climber_input_queue_;
}

c2017::climber::ClimberStatusQueue* QueueManager::climber_status_queue() {
  return &climber_status_queue_;
}

// Vision
c2017::vision::VisionInputQueue* QueueManager::vision_input_queue() {
  return &vision_input_queue_;
}
...
c2017::vision::VisionGoalQueue* QueueManager::vision_goal_queue() {
  return &vision_goal_queue_;
}
